...
// length
// ye [data-length-display] syntex hain agar querySelector se get krna chahate hain costume attribute ko
...
function shuffleArray(array) {
    for (let i = array.length - 1; i > 0; i--) {
      // find out random j using random function
